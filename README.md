# Octoco AI Course — Exercises

Starter code for the Octoco AI workshop combos. Auto-published from the source
course repo on every push to main; do not edit directly.

## combo1-agentic-engineering-intro

- [`tiny-agent`](combo1-agentic-engineering-intro/tiny-agent)
...
- [`expense-categoriser-java`](combo2-advanced-agentic-engineering/expense-categoriser-java)
...
- [`legacy-service-java`](combo2-advanced-agentic-engineering/legacy-service-java)
...
- [`tiny-agent-java`](combo2-advanced-agentic-engineering/tiny-agent-java)
...
- [`chroma-corpora`](combo3-building-agents/chroma-corpora)
- [`mcp-server`](combo3-building-agents/mcp-server)
...
- [`legacy-service-java`](combo4-agentic-engineering-in-practice/legacy-service-java)
