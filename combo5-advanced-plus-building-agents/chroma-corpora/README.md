...
├── FACILITATOR.md            ← notes for running M11
├── pyproject.toml
...
- **Not a RAG tutorial.** Retrieval-augmented generation has many more pieces (re-ranking, query rewriting, hybrid search). This is the minimal "search over documents" slice needed for M11.
