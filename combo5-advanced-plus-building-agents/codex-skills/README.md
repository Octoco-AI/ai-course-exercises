...
Workshop-authored Codex CLI skills for Combo 5 M3b (*Specs with teeth — lightweight path*). Attendees install these during the module, then customise for their own project.
...
Both implement the same conceptual flow. The lightweight skill version is what Combo 5 M3b live-creates; SpecKit is shown in M3c.
