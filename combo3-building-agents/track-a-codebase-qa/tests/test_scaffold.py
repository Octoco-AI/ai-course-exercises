...
These confirm the *given* plumbing works, independent of whether Module 1,
2, or 3 are done yet. `./verify.sh` runs this file specifically so it
stays green on a fresh clone; run `pytest -m m1` / `m2` / `m3` for the
