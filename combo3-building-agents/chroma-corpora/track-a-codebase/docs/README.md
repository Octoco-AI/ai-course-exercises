...
A small todo-list microservice used as the fictional codebase for Track A of Combo 3's running artefact. The agent in M34 answers questions about this code using a Chroma-indexed corpus of the documents under this directory.
