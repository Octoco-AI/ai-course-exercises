...
/// <remarks>
/// <para>
/// <b>Defaults to your code.</b> Set <c>TINY_AGENT_IMPL=reference</c> to run the
/// same suite against the worked solution — useful to confirm the tests
/// themselves are sane, or to see green before you start.
/// </para>
/// <code>
/// dotnet test                                    # tests YOUR StarterTools
...
public static class ToolsFactory
{
    public static ITools Create(string sandboxRoot)
    {
        ...
        return impl switch
        {
            "reference" => new Reference.ReferenceTools(sandboxRoot),
            "starter" or null or "" => new Starter.StarterTools(sandboxRoot),
    ...
    public static string Describe() =>
        Environment.GetEnvironmentVariable("TINY_AGENT_IMPL") is "reference"
